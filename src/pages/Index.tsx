...
import { CheckCircle, Leaf, Palette, Mail, Phone, MapPin } from "lucide-react";
...
const Index = () => {
  ...
  const team = [
    {
      ...
      image: teamMember1,
      description: "Lara Williams även känd som Mixora UFs enda tjej brukar äta en kaka efter en jobbig skoldag.",
    },
    {
      id: 2,
      name: "Hassan Haydar",
      role: "Sälj,marknad och produktansvarig.",
      image: teamMember2,
      description: "Hassan Haydar även känd som Mixora UFs bästa säljare brukar unna sig en kaka efter MMA träningarna.",
    },
    {
      id: 3,
      name: "Elias Sethson",
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-muted-foreground">
              Våra bakmixer gör det lätt att baka goda och trendiga bakverk, snabbt och utan krångel.
            </p>
          </div>
          <div className="text-center animate-fade-in" style={{ animationDelay: "0.1s" }}>
            ...
            <p className="text-muted-foreground">
              Vi värnar om miljön genom att använda noggrant utvalda, hållbara ingredienser och förpackningar.
            </p>
          </div>
          <div className="text-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-muted-foreground">Våra bakmixer kommer inehålla kvalitativa råvaror.</p>
          </div>
        </div>
      </section>
  ...
  Upptäck vårt sortiment av noggrant sammansatta bakpaket.
</p>

<p className="text-md text-muted-foreground mt-2">
  (Sugen på att köpa? Kontakta oss på Instagram eller mail)
</p>
          </div>
      ...
      <section id="team" className="py-20 px-4 bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Passionerade entreprenörer och produktutvecklare som gör Mixora möjligt
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Har du frågor om våra produkter eller vill diskutera ett samarbete? Hör av dig!
            </p>
            <p className="text-md text-muted-foreground mt-2">
  (Sugen på att köpa? Kontakta oss på Instagram eller mail)
</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:0704693042" className="text-muted-foreground hover:text-primary transition-colors">
                        070 469 30 42
                      </a>
                    </div>
                  </div>
